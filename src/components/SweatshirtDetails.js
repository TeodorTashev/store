    ...
    const sweatshirts = [
        {
            ...
            color: "Бяло",
            gender: "Дамски",
            description: "Топъл памучен суитшърт с традиционни български мотиви. Удобен и практичен за всеки сезон.",
            sizes: {
        ...
        },
        {
            ...
            color: "Зелен",
            gender: "Мъжки",
            description: "Топъл памучен суитшърт с цип и традиционни български мотиви. Удобен и практичен за всеки сезон.",
            sizes: {
        ...
        },
        {
            ...
            color: "Черно",
            gender: "Мъжки",
            description: "Топъл памучен суитшърт с цип, качулка и традиционни български мотиви. Удобен и практичен за всеки сезон.",
            sizes: {
                'S': { width: 51, height: 67 },
                'M': { width: 56, height: 70 },
                'L': { width: 61, height: 73 },
